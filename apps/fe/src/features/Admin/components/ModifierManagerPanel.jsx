  ...
  return (
    <div className="py-3 flex items-start justify-between gap-3 border-b border-white/5">
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2 h-3 w-72 bg-white dark:bg-neutral-950/5 rounded animate-pulse" />
      </div>
      <div className="h-8 w-28 bg-white dark:bg-neutral-950/5 rounded-xl animate-pulse" />
    </div>
  );
}
